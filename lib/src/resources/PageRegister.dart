...
class _PageRegisterState extends State <PageRegister> {
              ...
              child: Column(
                children: <Widget>[
                        ...
                        children: <Widget>[
                          ...
                          StreamBuilder(
                            ...
                            builder: (context, snapshot) => TextField(
                              ...
                              obscureText: !_showConfirmPass, //Security password
                              decoration: InputDecoration(
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: <Widget>[
                      Text("Đã có Tài khoản? ", style: TextStyle(fontFamily: "SFUIText-Bold", fontSize: 16.0),),
                      InkWell(
                        onTap: () {
                          Navigator.pop(context);
                        },
                        child: Text(
                          "Đăng nhập", style: TextStyle(fontFamily: "SFUIText-Bold", color: Colors.blue[700], fontSize: 17.0),
                        )
                      )
                    ],
                  )
  ...
  void _submitLogin() async {
    ...
    if (isValid) {
      ...
      bloc.signUp(_emailController.text, _passController.text, _nameController.text, () {
        LoadingDialog.hideLoadingDialog(context);
        MassageDialog.showMessageDialog(context, "Đăng ký", 'Đăng ký thành công!\n Vui lòng đăng nhập hệ thống!');
        Navigator.push(
