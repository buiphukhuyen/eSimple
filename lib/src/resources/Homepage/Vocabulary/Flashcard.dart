                  ...
                  startgame
                      ? Stack(
                          children: <Widget>[
                            Padding(
                              padding:
                                  EdgeInsets.fromLTRB(23.0, 210, 15.0, 200),
                            ...
                            Container(
                              padding:
                                  EdgeInsets.fromLTRB(15.0, 200.0, 15.0, 20.0),
                          ...
                          child: Swiper(
                            itemBuilder: (BuildContext context, int index) {
                              return FlipCard(
                                ...
                                onFlip: () {
                                  audioCache.play("audio/flipcard.mp3",
                                      volume: 0.2);
                                },
                              );
                            },
