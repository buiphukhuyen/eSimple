...
import 'package:english_app/src/resources/ForgotPassword.dart';
...
import 'package:english_app/src/resources/PageRegister.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      ...
      body: Stack(
        ...
        children: <Widget>[
          Column(
            crossAxisAlignment: CrossAxisAlignment.end, //Căn chỉnh trục, các text nằm từ phải sang
            children: <Widget>[
              Padding(
                padding: EdgeInsets.only(top: 20.0),
                child: Image.asset("assets/images/Banner_Top_LoginSocial.png", gaplessPlayback: true),
              ),
              Expanded(
                child: Container(),
              ),
              ...
              child: Column(
                children: <Widget>[
                            ...
                            child: Stack(
                              ...
                              children: <Widget>[
                                StreamBuilder(
                                  ...
                                  builder: (context, snapshot) => TextField(
                                    obscureText: !_showpass, //Security password
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: <Widget>[
                      Text("Chưa có tài khoản? ", style: TextStyle(fontFamily: "SFUIText-Bold", fontSize: 16.0),),
                      InkWell(
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => PageRegister()));
                        },
                        child: Text(
                          "Đăng ký", style: TextStyle(fontFamily: "SFUIText-Bold", color: Colors.blue[700], fontSize: 17.0),
                        )
                      )
                    ],
