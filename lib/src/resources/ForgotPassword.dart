            ...
            child: Padding(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Text('1. Bạn chỉ có thể Khôi phục Mật khẩu nếu Địa chỉ Email tồn tại trên hệ thống.', 
                    style: TextStyle(
                      fontSize: 17.0
                    ),
                  ),
                   SizedBox(height: ScreenUtil.getInstance().setHeight(10),),
                 Text('2. Kiểm tra lại Email và Xác nhận Đường dẫn để tiến hành thay đổi Mật khẩu.', 
                    style: TextStyle(
                      fontSize: 17.0
                    ),
                  ),
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: <Widget>[
                      Text("Chưa có tài khoản? ", style: TextStyle(fontFamily: "SFUIText-Bold", fontSize: 18.0),),
                      InkWell(
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => PageRegister()));
                        },
                        child: Text(
                          "Đăng ký", style: TextStyle(fontFamily: "SFUIText-Bold", color: Colors.blue[700], fontSize: 19.0),
                        )
                      )
                    ],
